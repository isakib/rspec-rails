Feature: Feature spec
  ...
  `disable_monkey_patching!` mode. Refer to the [capybara API documentation](http://rubydoc.info/github/jnicklas/capybara/master)
  for more information on the methods and matchers that can be used in feature
  specs.
  ...
  [customer tests](http://c2.com/cgi/wiki?CustomerTest) and [acceptance
  tests](http://c2.com/cgi/wiki?AcceptanceTest). When capybara is required it sets
    ...
    And the output should contain:
      ...
      Pending:
        Widget management User creates a new widget
          # Feature specs require the Capybara (http://github.com/jnicklas/capybara) gem, version 2.2.0 or later. We recommend version 2.4.0 or later to avoid some deprecation warnings and have support for `disable_monkey_patching!` mode.
